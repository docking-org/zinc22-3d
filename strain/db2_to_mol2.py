...
class db2conformer: # C
    def __init__(self,num,seglist,energy):
        self.num = int(num)
    ...
    for line in lines:
         ...
         #   print line
            ...
            if (fristflag):
                ...
                tempconf = db2conformer(num,segnum_list,energy)
...
def convert_db2_to_mol2(db2mols):
    ...
    for mol in db2mols: 
         ...
         for conf in mol.conformer_list:
              ...
              mol2mol = mol2.Mol("####### int_energy: %6.3f\n"%int_energy,"",mol2atomlist,mol2bondlist,residue_list)
...
def main():
    if len(sys.argv) != 3: # if no input
        print "Syntax: python db2_to_mol2.py db2file.db2.gz outprefix ";
        return
