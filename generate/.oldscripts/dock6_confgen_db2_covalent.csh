...
foreach anchor ($list)
  ...
  if ( -z output_anchor${count}_scored.mol2 || !(-e output_anchor${count}_scored.mol2) ) then
     ...
     python ${dock3home}/ligand/mol2db2/mol2db2.py --norotateh -m output_anchor${count}_scored.mol2 -s output.solv -n name.txt -o output_anchor${count}_scored.db2.gz -v --covalent
  endif
