...
#GENERATE_RIGID_FRAGMENT_CONFORMATIONS_EXE="${GENERATE_RIGID_FRAGMENT_CONFORMATIONS_EXE-${DOCKBASE}/ligand/omega/omega_db2.e.run.omega.py}"
GENERATE_RIGID_FRAGMENT_CONFORMATIONS_EXE="${GENERATE_RIGID_FRAGMENT_CONFORMATIONS_EXE-${DOCKBASE}/ligand/omega/omega_db2.e.run.omega_mod.py}"
#GENERATE_COVALENT_CONFORMATIONS_EXE="${COVALENT_CONFORMATIONS_EXE-${DOCKBASE}/ligand/omega/omega_warhead.py}"
GENERATE_COVALENT_CONFORMATIONS_EXE="${COVALENT_CONFORMATIONS_EXE-${DOCKBASE}/ligand/omega/omega_warhead.run.omega.py}"
...
do
    ...
    do
        ...
        ln -svfn ../${COMPOUND_NAME}.ism ${COMPOUND_NAME}.smi 1>&2
        echo " I AM HERE (0) "
